"""More columns and Relationship

Revision ID: 118902d422f7
Revises: a50cde241c4b
Create Date: 2023-06-21 15:28:36.842876
...
def upgrade():
    ...
    with op.batch_alter_table('bakeries', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('updated_at', sa.DateTime(), nullable=True))
        batch_op.create_unique_constraint('name', ['name'])
        batch_op.create_foreign_key_constraint(['bakery_id'], ['bakeries.id'])
